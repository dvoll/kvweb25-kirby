...
?>
<div
    class="dvll-block dvll-block--wide flex gap-4" x-data>
    <div class="stage-welcome grid grid-cols-[auto_repeat(5,_1fr)] sm:grid-cols-[minmax(0,_calc(10%_+_50vw_-_25vh))_repeat(5,_1fr)] lg:grid-cols-[auto_repeat(5,_1fr)] grid-rows-[1fr_repeat(4,_auto)] lg:grid-rows-[1fr_repeat(4,_auto)] gap-1.5 md:gap-2 lg:gap-3 grow [--flip-start-delay:1.8s]">
        ...
        <?php foreach ($images as $stageImage): ?>
            ...
            <div class="stage-welcome__item shadow-lg overflow-clip rounded-sm lg:rounded-md transition-flip transition--initial stage-welcome-item-<?= $imageIndex + 1; ?>">
        ...
        <?php endforeach; ?>
        <!-- Shadow -->
        <?php for ($shadow = 0; $shadow < $shadowElementCount; $shadow++): ?>
            <div class="stage-welcome__shadow stage-welcome-shadow-<?= $shadow + 1; ?>"></div>
        <?php endfor; ?>
    </div>
</div>
